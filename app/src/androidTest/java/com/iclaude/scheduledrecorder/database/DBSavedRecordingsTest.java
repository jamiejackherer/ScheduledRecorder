...
public class DBSavedRecordingsTest {
    ...
    public void insertRecordingAndGetById() {
        ...
        assertRecording(loaded, RECORDING.getId(), RECORDING.getName(), RECORDING.getPath(), RECORDING.getLength(), RECORDING.getTimeAdded());
    }
    ...
    public void insertRecordingReplacesOnConflict() {
        ...
        // The loaded data contains the expected values
        assertRecording(loaded, 25, newRecording.getName(), newRecording.getPath(), newRecording.getLength(), newRecording.getTimeAdded());
    }
    ...
    public void insertRecordingAndGetRecordings() throws Exception {
        ...
        // The loaded data contains the expected values
        assertRecording(recordings.get(0), RECORDING.getId(), RECORDING.getName(), RECORDING.getPath(), RECORDING.getLength(), RECORDING.getTimeAdded());
    }
    ...
    public void updateRecordingAndGetById() {
        ...
        // The loaded data contains the expected values
        assertRecording(loaded, 25, updatedRecording.getName(), updatedRecording.getPath(), updatedRecording.getLength(), updatedRecording.getTimeAdded());
    }
